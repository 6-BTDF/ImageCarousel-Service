...
const numEnd = 1000000;
const fileName = 'listingDetailsNineM.json';
...
const listingDetailsDataGen = (i, end, stream, encoding, cb) => {
  function writing() {
    let ok = true;
    do {
      i--;
...
listingDetailsDataGen(numLines, numEnd, stream, 'utf8', () => {
  stream.end();
